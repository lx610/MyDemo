...
public class TextSpanListAdapter extends BaseQuickAdapter<TextSpanBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, TextSpanBean item) {
        ...
        ReadMoreTextView readMoreTextView = helper.getView(R.id.tv_text);
        readMoreTextView.clearSpanList();
        ...
        readMoreTextView.addSpannableString(spanBean);


        readMoreTextView.setText(content);
