...
public class StaticOutAndInerClassFragment extends BaseLinearFragment {
    private TextView mLogText;
    StaticInerClass outClass = new StaticInerClass();
    StaticInerClass.inerClass inerClass = new StaticInerClass. inerClass();
